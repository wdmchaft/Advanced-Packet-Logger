function [var, foundFlg] = findSpaceNextract(key, verbose, writeFile, fid, DirWrite);
%function [var, foundFlg] = findSpaceNextract(key, verbose, writeFile, fid);
%Reads the "fid" file looking for a line starting with the key word - trims
%leading spaces.  findNextract is similar but disallows leading spaces.
