...
if codeVersion
  reply = sprintf('dispNghbrhdSmry Version %.3f (Debug) created 21-Jan-2011 18:19:57.', codeVersion);
else % if codeVersion
  reply = sprintf('dispNghbrhdSmry created  (Debug)21-Jan-2011 18:19:57.');
end % if codeVersion
